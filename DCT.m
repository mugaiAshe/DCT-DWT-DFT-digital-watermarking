...
result = uint8(result);
imwrite(result,'离散余弦.jpeg','jpeg');      %存储添加水印后的图像
...
switch choice        %读入输入的选择  withmark为等待提取水印的图像
    case 1
        ...
        imwrite(withmark,'余-噪声.jpeg','jpeg'); 
    case 2
         result_2=result;
    ...
    case 3
        ...
        title('上方剪切后图像');
        withmark=result_3;
        imwrite(withmark,'余-剪切.jpeg','jpeg'); 
    case 4
        ...
        title('旋转10度后图像');
        withmark=result_4;
        imwrite(withmark,'余-旋转.jpeg','jpeg'); 
    case 5
        result_5 = result; 
        ...
        title('经JPEG压缩后图像'); 
        withmark=WImage5cl;
        imwrite(withmark,'余-缩放.jpeg','jpeg'); 
    case 6
        result_6=result;
...
subplot(2,3,6);
imshow(mark_3),title('原水印');
imwrite(mark_2,'离散余弦水印.png','png'); 
